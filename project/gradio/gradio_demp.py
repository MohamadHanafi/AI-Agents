...
demo = gr.Interface(
    fn=combine_strings, 
    inputs=[gr.Textbox(label="String 1"), gr.Textbox(label="String 2")], # Create two text input fields where users can enter strings
    outputs=gr.Textbox(label="Combined String") # Create a text output field to display the combined string
)
